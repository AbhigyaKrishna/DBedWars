...
public abstract class HologramPage {
    ...
    public abstract void addAction(HologramClickAction action);

    public abstract Set<HologramClickAction> getActions();

    public abstract void removeAction(Predicate<HologramClickAction> predicate);
