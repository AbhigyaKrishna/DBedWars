...
public class ViewItem implements com.pepedevs.dbedwars.api.game.view.ViewItem {
    ...
    private Map<AttributeType, com.pepedevs.dbedwars.api.game.view.ViewItem.Attribute> attributes;
    ...
    public ViewItem(
        ...
        this.enchants =
                item.getEnchant().stream().map(LEnchant::valueOf).collect(Collectors.toList());
        this.attributes = new ConcurrentHashMap<>();
        this.page = page;
    ...
    public Map<AttributeType, com.pepedevs.dbedwars.api.game.view.ViewItem.Attribute>
            getAttributes() {
    ...
    public ActionItem getActionItem(boolean recreate) {
        ...
        if (this.attributes.containsKey(AttributeType.PURCHASABLE)) {
            com.pepedevs.dbedwars.api.game.view.ViewItem.Attribute purchasable =
                        ...
                        new ItemAction() {
                            ...
                            public void onClick(ItemClickAction itemClickAction) {
                                if (event.getCost().stream()
                                        .allMatch(
                                                i ->
                                                        BwItemStack.playerHas(
                                                                itemClickAction.getPlayer(), i))) {
                                    event.call();
                                            ...
                                            (s, i) -> {
                                                ...
                                                if (x > -1) {
                                                    itemClickAction
                                                            .getPlayer()
                                                            .getInventory()
                                                            .setItem(x, i.toItemStack());
                                                } else {
                                                    itemClickAction
                                                            .getPlayer()
                                                            .getInventory()
                                                            .addItem(i.toItemStack());
                                                }
                                            });
                                }
                            }
            ...
            if (this.attributes.containsKey(AttributeType.UPGRADEABLE_TIER)) {
                com.pepedevs.dbedwars.api.game.view.ViewItem.Attribute upgradeTier =
                        this.attributes.get(AttributeType.UPGRADEABLE_TIER);
                String nextTier =
                        (String)
                                upgradeTier
                                        .getKeyEntry()
                                        .get(AttributeType.UPGRADEABLE_TIER.getConfigKeys()[0]);
                com.pepedevs.dbedwars.api.game.view.ViewItem vi = null;
                ...
                for (Map.Entry<String, ShopPage> entry :
                        ((ShopView) this.player.getShopView()).getShopPages().entrySet()) {
                ...
                if (vi != null) {
                    com.pepedevs.dbedwars.api.game.view.ViewItem finalVi = vi;
                            ...
                            new ItemAction() {
                                ...
                                public void onClick(ItemClickAction itemClickAction) {
                                    if (event.getCost().stream()
                                        ...
                                        itemClickAction
                                                .getMenu()
                                                .setItem(itemClickAction.getSlot(), nextItem);
                                        ...
                                        itemClickAction
                                                .getMenu()
                                                .update(itemClickAction.getPlayer());
                                    }
                                }
                            });
                }
        ...
        if (this.attributes.containsKey(AttributeType.COMMAND)) {
            com.pepedevs.dbedwars.api.game.view.ViewItem.Attribute command =
        ...
        if (this.attributes.containsKey(AttributeType.CHANGE_PAGE)) {
            com.pepedevs.dbedwars.api.game.view.ViewItem.Attribute page =
    ...
    public List<String> getAllUpgradeTier() {
        ...
        if (this.attributes.containsKey(AttributeType.UPGRADEABLE_TIER)) {
            com.pepedevs.dbedwars.api.game.view.ViewItem viewItem = this;
            do {
                com.pepedevs.dbedwars.api.game.view.ViewItem.Attribute upgradeTier =
                        ((ViewItem) viewItem).getAttributes().get(AttributeType.UPGRADEABLE_TIER);
                String nextTier =
                        (String)
                                upgradeTier
                                        .getKeyEntry()
    ...
    public class Attribute implements com.pepedevs.dbedwars.api.game.view.ViewItem.Attribute {
