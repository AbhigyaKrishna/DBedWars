...
public class Villager extends EntityVillager implements IVillager {
    ...
    public Villager(NMSAdaptor adaptor, Location location) {
        ...
        this.setPositionRotation(this.location.getX(), this.location.getY(), this.location.getZ(), this.location.getYaw(), this.location.getPitch());
    }
    ...
    @Override
    public void spawn() {
        ((CraftWorld) this.location.getWorld()).getHandle().addEntity(this, CreatureSpawnEvent.SpawnReason.CUSTOM);
