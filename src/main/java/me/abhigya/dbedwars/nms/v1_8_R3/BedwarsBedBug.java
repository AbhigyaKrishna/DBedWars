...
public class BedwarsBedBug implements IBedBug {
    ...
    public IBedBug initTargets(double reachModifier) {
        bedBug.goalSelector.a(4, new PathfinderGoalMeleeAttack(bedBug, EntityHuman.class, reachModifier, false));
        bedBug.targetSelector.a(2, new PathFindingNearestAttackableTarget<>(bedBug,EntityHuman.class,true,false,spawningTeam));
        return this;
    }
    ...
    private static class PathFindingNearestAttackableTarget<T extends EntityLiving > extends PathfinderGoalNearestAttackableTarget<T> {
        ...
        public PathFindingNearestAttackableTarget( EntityCreature entitycreature, Class< T > oclass, boolean flag, boolean flag1,Team spawningTeam) {
