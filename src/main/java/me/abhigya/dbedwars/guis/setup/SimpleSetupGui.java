    ...
    save.addAction(
        new ItemAction() {
          ...
          public void onClick(ItemClickAction itemClickAction) {
            ...
            itemClickAction
                .getPlayer()
                .sendMessage(StringUtils.translateAlternateColorCodes("&aArena Saved!"));
          }
        });
  ...
  private void renderPageOne(Arena arena) {
        ...
        new ItemAction() {
          ...
          public void onClick(ItemClickAction itemClickAction) {
            if (itemClickAction.getClickType().equals(ClickType.LEFT)) {
              arena
                  .getSettings()
                  .setLobby(LocationXYZYP.valueOf(itemClickAction.getPlayer().getLocation()));
              arena
                  .getSettings()
              ...
              itemClickAction
                  .getPlayer()
                  .sendMessage(StringUtils.translateAlternateColorCodes("&aLobby location set!"));
            } else if (itemClickAction.getClickType().equals(ClickType.RIGHT)) {
              if (arena.getSettings().hasLobby()) {
                if (SimpleSetupGui.this.plugin.getServer().getWorld(arena.getSettings().getName())
                    == null) {
                                  ...
                                  .addSyncWork(
                                      () ->
                                          itemClickAction
                                              .getPlayer()
                                              .teleport(
                                                  arena.getSettings().getLobby().toBukkit(world)));
                            });
                  } else {
                    itemClickAction
                        .getPlayer()
                        .sendMessage(
                            StringUtils.translateAlternateColorCodes(
                                "&cArena world not set. Teleporting to location in current"
                                    + " world!"));
                    itemClickAction
                        .getPlayer()
                        .teleport(
                            arena
                                .getSettings()
                                .getLobby()
                                .toBukkit(itemClickAction.getPlayer().getWorld()));
                  }
                }
              } else {
                itemClickAction
    ...
    ActionItem world =
        new ActionItem(
            ...
            StringUtils.translateAlternateColorCodes(
                new String[] {"&eClick to set arena world to current world.", "&eAnd save it"}));
    world.addAction(
        new ItemAction() {
          @Override
          public ItemActionPriority getPriority() {
          ...
          public void onClick(ItemClickAction itemClickAction) {
            ...
            if (world.equals(SimpleSetupGui.this.plugin.getMainWorld())
                || world.equals(SimpleSetupGui.this.plugin.getMainWorld() + "_nether")
                              ...
                              p ->
                                  p.teleport(
                                      SimpleSetupGui.this
                                          .plugin
                                          .getServer()
                                          .getWorld(SimpleSetupGui.this.plugin.getMainWorld())
                                          .getSpawnLocation()));
                      SimpleSetupGui.this
                          .plugin
                          .getGeneratorHandler()
                    ...
                    () -> {
                      ...
                      if (arena.getWorld() != null)
                        SimpleSetupGui.this
                            ...
                            .getGeneratorHandler()
                            .getWorldAdaptor()
                            .unloadWorld(arena.getWorld().getName(), false);
      ...
      if (enabledColor.contains(colors[i])) {
        color =
            new ActionItem(
                ...
                StringUtils.translateAlternateColorCodes(
                    new String[] {
                      "&eLeft click to open team settings.", "&cRight click to disable team."
                    }));
        byte finalI1 = i;
        color.addAction(
            new ItemAction() {
                ...
                if (itemClickAction.getClickType().equals(ClickType.LEFT)) {
                  ...
                  info.put(
                      ...
                      arena.getSettings().getAvailableTeams().stream()
                          .filter(t -> t.getColor().equals(colors[finalI1]))
                          .findFirst()
                          .get());
                  SimpleSetupGui.this
                      .plugin
    ...
    if (page == 1) {
      ...
      next.setLore(
          Collections.singletonList(
              StringUtils.translateAlternateColorCodes("&fAdd team assets for each team.")));
      next.addAction(
          new ItemAction() {
            @Override
            public ItemActionPriority getPriority() {
      ...
      back.setLore(
          Collections.singletonList(
              StringUtils.translateAlternateColorCodes("&fConfigure basic settings.")));
      back.addAction(
          new ItemAction() {
            @Override
            public ItemActionPriority getPriority() {
      ...
      next =
          new ActionItem(
              ...
              Collections.singletonList(
                  StringUtils.translateAlternateColorCodes("&fand enable arena.")));
    }
