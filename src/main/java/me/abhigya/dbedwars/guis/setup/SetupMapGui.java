      ...
      switch (b) {
        case 2:
          if (info.get("type").equals("final")
            ...
            ActionItem world =
                new ActionItem(
                    StringUtils.translateAlternateColorCodes("&eGenerate arena world!"),
                            ...
                            () -> {
                              if (arena.isEnabled()) {
                                itemClickAction
                                    ...
                                    .sendMessage(
                                        StringUtils.translateAlternateColorCodes(
                                            "&cPlease disable the arena to make changes in the"
                                                + " world or load world!"));
                                return;
                              }
                                          ...
                                          action
                                              ...
                                              .teleport(
                                                  arena
                                                      .getSettings()
                                                      .getLobby()
                                                      .toBukkit(arena.getWorld()));
                                        } else {
                                          action
                                              .getPlayer()
                                              .teleport(arena.getWorld().getSpawnLocation());
                                        }
                                      });
                            });
                  }
                        ...
                        () -> {
                          World world =
                              SetupMapGui.this
                                  ...
                                  .getGeneratorHandler()
                                  .getWorldAdaptor()
                                  .loadWorldFromFolder(file.getName());
