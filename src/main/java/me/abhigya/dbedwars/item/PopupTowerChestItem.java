...
public class PopupTowerChestItem extends PluginActionItem {
    ...
    public PopupTowerChestItem(DBedwars plugin) {
        super(plugin, StringUtils.translateAlternateColorCodes(plugin.getConfigHandler().getCustomItems().getPopupTower().getName()),
                StringUtils.translateAlternateColorCodes((plugin.getConfigHandler().getCustomItems().getPopupTower().getLore() == null ? new ArrayList<>() : plugin.getConfigHandler().getCustomItems().getPopupTower().getLore())),
