...
import me.abhigya.dbedwars.task.PopupTowerWorkload;
...
public class PopupTowerChestItem extends PluginActionItem {
  ...
  public static class PopupTowerBlocks {
    ...
    public static LinkedHashMap<Block, Material> getEastBlocks(Block centre, XMaterial material) {
    ...
    public static LinkedHashMap<Block, Material> getWestBlocks(Block centre, XMaterial material) {
      LinkedHashMap<Block, Material> blocks = new LinkedHashMap<>();
    ...
    public static LinkedHashMap<Block, Material> getSouthBlocks(Block centre, XMaterial material) {
      LinkedHashMap<Block, Material> blocks = new LinkedHashMap<>();
      blocks.put(centre.getRelative(1, 0, 2), material.parseMaterial());
      blocks.put(centre.getRelative(0, 0, 2), material.parseMaterial());
      blocks.put(centre.getRelative(-1, 0, 2), material.parseMaterial());
    ...
    public static LinkedHashMap<Block, Material> getNorthBlocks(Block centre, XMaterial material) {
      LinkedHashMap<Block, Material> blocks = new LinkedHashMap<>();
      blocks.put(centre.getRelative(1, 0, -2), material.parseMaterial());
      blocks.put(centre.getRelative(0, 0, -2), material.parseMaterial());
      blocks.put(centre.getRelative(-1, 0, -2), material.parseMaterial());
