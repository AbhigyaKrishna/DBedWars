...
public class DreamDefenderSpawnEgg extends PluginActionItem {
  ...
  public DreamDefenderSpawnEgg(DBedwars plugin) {
    super(
        ...
        StringUtils.translateAlternateColorCodes(
            plugin.getConfigHandler().getCustomItems().getDreamDefender().getItemName()),
        StringUtils.translateAlternateColorCodes(
            (plugin.getConfigHandler().getCustomItems().getDreamDefender().getItemLore() == null
                ? new ArrayList<>()
  ...
  public void onActionPerform(
    ...
    if (plugin.getGameManager().getArena(player.getWorld().getName()) != null
      ...
      plugin
          .getThreadHandler()
          .addAsyncWork(new GolemDisplayNameUpdateTask(ironGolem, arenaPlayer.getTeam(), cfgGolem));
    }
  }
