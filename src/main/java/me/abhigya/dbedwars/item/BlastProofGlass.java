...
public class BlastProofGlass extends PluginActionItem {
    ...
    public BlastProofGlass(DBedwars plugin) {
        super(plugin,plugin.getConfigHandler().getCustomItems().getBlastProofGlass().getGlassItemName(),
    ...
    public void onTNTExplode(EntityExplodeEvent event){
        ...
        while (blockIterator.hasNext()) {
            ...
            if (block.getType() != Material.AIR) {
                if (Utils.containsGlass(getBlockPathX(event.getEntity().getLocation().getBlock().getLocation(),block.getLocation())) &&
                        Utils.containsGlass(getBlockPathY(event.getEntity().getLocation().getBlock().getLocation(),block.getLocation()))){
    ...
    public void onFireballExplode(EntityExplodeEvent event){
        ...
        while (blockIterator.hasNext()) {
            ...
            if (block.getType() != Material.AIR && XMaterial.matchXMaterial(block.getType()) != XMaterial.END_STONE) {
                if (Utils.containsGlassOrEndstone(getBlockPathX(event.getEntity().getLocation().getBlock().getLocation(),block.getLocation())) &&
                        Utils.containsGlassOrEndstone(getBlockPathY(event.getEntity().getLocation().getBlock().getLocation(),block.getLocation()))){
                    blockIterator.remove();
                }
            }
        }
