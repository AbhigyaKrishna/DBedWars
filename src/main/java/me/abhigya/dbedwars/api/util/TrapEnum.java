                ...
                if ( split.length == 4 && NumberUtils.isDigits( split[1] ) && NumberUtils.isDigits( split[2] ) && NumberUtils.isDigits( split[3] ) ) {
                    return new Consumer< ArenaPlayer >( ) {
                        ...
                        public void accept( ArenaPlayer player ) {
                            TitleUtils.send( player.getPlayer( ), StringUtils.translateAlternateColorCodes( title ),
        ...
        ACTION_BAR {
            ...
            public Consumer< ArenaPlayer > getAction( String statement ) {
                ...
                return new Consumer< ArenaPlayer >( ) {
                    @Override
                    public void accept( ArenaPlayer player ) {
                        ActionBarUtils.send( player.getPlayer( ), StringUtils.translateAlternateColorCodes( main ) );
                    }
                };
            }
        },
