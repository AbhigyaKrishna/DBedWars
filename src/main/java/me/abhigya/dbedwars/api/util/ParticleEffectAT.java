...
public class ParticleEffectAT {
    ...
    public ParticleEffectAT(Particle effect){
        this.effect = ParticleEffect.valueOf(effect.name());
    }
    ...
    public ParticleBuilder build(){
        ...
        if (this.amount != null)
            builder.setAmount(amount.get());
        if (this.speed != null)
            builder.setSpeed(speed.floatValue());
        return builder;
