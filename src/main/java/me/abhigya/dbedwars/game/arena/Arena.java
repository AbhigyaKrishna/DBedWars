...
public class Arena implements me.abhigya.dbedwars.api.game.Arena {
    ...
    public Arena(DBedwars plugin) {
        this.plugin = plugin;
        this.settings =
                new me.abhigya.dbedwars.game.arena.settings.ArenaSettings(this.plugin, this);
    ...
    public void reloadData() {
        ...
        ((me.abhigya.dbedwars.game.arena.settings.ArenaSettings) this.settings)
