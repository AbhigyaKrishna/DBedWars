...
import me.abhigya.dbedwars.configuration.configurable.ConfigurableArenaOverride;
import me.abhigya.dbedwars.configuration.configurable.ConfigurableItemSpawner;

import java.util.*;

public class DropType implements me.abhigya.dbedwars.api.game.spawner.DropType {
    ...
    private Map< Integer, me.abhigya.dbedwars.api.game.spawner.DropType.Tier > tiers;
    ...
    @Override
    public me.abhigya.dbedwars.api.game.spawner.DropType.Tier getTier( int level ) {
    ...
    @Override
    public Map< Integer, me.abhigya.dbedwars.api.game.spawner.DropType.Tier > getTiers( ) {
        return this.tiers;
    }
    ...
    public static class Tier implements me.abhigya.dbedwars.api.game.spawner.DropType.Tier {

        private double delay;
        private SoundVP upgradeSound;
        private ParticleEffect upgradeEffect;
        private String upgradeMessage;
        private Map< String, me.abhigya.dbedwars.api.game.spawner.DropType.Drop > drops;
        ...
        @Override
        public List< me.abhigya.dbedwars.api.game.spawner.DropType.Drop > getDrops( ) {
            return new ArrayList<>( this.drops.values( ) );
        }

        @Override
        public Map< String, me.abhigya.dbedwars.api.game.spawner.DropType.Drop > getDropMap( ) {
            return this.drops;
        }
    ...
    public static class Drop implements me.abhigya.dbedwars.api.game.spawner.DropType.Drop {
