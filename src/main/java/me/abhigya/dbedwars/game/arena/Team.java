        ...
        p ->
            p.sendMessage(
                ConfigurationUtils.parseMessage(
                    ConfigurationUtils.parsePlaceholder(message, p.getPlayer()))));
  }
          ...
          ap.ifPresent(
              arenaPlayer -> {
                PlayerOpenShopEvent event =
                    new PlayerOpenShopEvent(arenaPlayer, this.arena, arenaPlayer.getShopView());
                event.call();
                ...
                DBedwars.getInstance()
                    ...
                    .getGuis()
                    .get("SHOP")
                    .open(null, Collections.singletonMap("player", arenaPlayer), player);
              });
        });
  }
