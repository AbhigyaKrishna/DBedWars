...
public class ArenaSettings implements me.abhigya.dbedwars.api.game.settings.ArenaSettings {
  ...
  public ArenaSettings(DBedwars plugin, Arena arena) {
    ...
    this.startTimer =
        this.plugin.getConfigHandler().getMainConfiguration().getArenaSection().getStartTimer();
    this.respawnTime =
        this.plugin.getConfigHandler().getMainConfiguration().getArenaSection().getRespawnTime();
    this.islandRadius =
        this.plugin.getConfigHandler().getMainConfiguration().getArenaSection().getIslandRadius();
    this.minYAxis =
        this.plugin.getConfigHandler().getMainConfiguration().getArenaSection().getMinYAxis();
    ...
    this.gameEndDelay =
        this.plugin.getConfigHandler().getMainConfiguration().getArenaSection().getGameEndDelay();
    this.disableHunger =
        this.plugin.getConfigHandler().getMainConfiguration().getArenaSection().isDisableHunger();
    this.bedDestroyPoint =
        this.plugin
            ...
            .getBedDestroyPoint();
    this.killPoint =
        this.plugin.getConfigHandler().getMainConfiguration().getArenaSection().getKillPoint();
    this.finalKillPoint =
        this.plugin.getConfigHandler().getMainConfiguration().getArenaSection().getFinalKillPoint();
    this.deathPoint =
        this.plugin.getConfigHandler().getMainConfiguration().getArenaSection().getDeathPoint();
  }
