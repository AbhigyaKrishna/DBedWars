...
public class UpgradeItem {
  ...
  public class UpgradeTier {
    ...
    public UpgradeTier(
        String key,
        ConfigurableUpgrade.ConfigurableUpgradePage.ConfigurableItem.ConfigurableUpgradeTier tier) {
      ...
      this.tier
          ...
          .forEach(
              a ->
                  this.actions.put(
                      ConfigurationUtils.matchEnum(a.getTarget(), Target.values()),
                      new TierAction(a)));
    }
