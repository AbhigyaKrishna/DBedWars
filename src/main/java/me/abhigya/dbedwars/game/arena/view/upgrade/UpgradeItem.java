...
public class UpgradeItem {
    ...
    public UpgradeItem( Team team, ConfigurableUpgrade.ConfigurableUpgradePage.ConfigurableItem item, String key, UpgradePage page ) {
        this.team = team;
        this.cfgItem = item;
        this.key = key;
        this.page = page;
    ...
    enum TierActionType {
        ENCHANT {
            ...
            public Consumer< ArenaPlayer > getAction( String statement ) {
                ...
                if ( material == null ) {
                    ItemConstant constant = ConfigurationUtils.matchEnum( split[1].trim( ), ItemConstant.values( ) );
                    if ( constant == null )
                        return super.getAction( statement );
