...
public class PostGreSqlBridge extends SQLDatabaseBridge {
    ...
    public PostGreSqlBridge(ConfigurableDatabase.ConfigurableMySQL cfg) {
        super(new PostGreSQL(cfg.getHost(), cfg.getPort(), cfg.getDatabaseName(), cfg.getUsername(), cfg.getPassword(), cfg.getParams(), createHikariConfig(DatabaseType.PostGreSQL)));
    }
