...
public class ArenaNew extends AbstractMessaging implements Arena {
    ...
    public ArenaNew(DBedwars plugin) {
        this(plugin, new ArenaSettingsImpl());
    }

    public ArenaNew(DBedwars plugin, ArenaSettingsImpl settings) {
        this.plugin = plugin;
    ...
    public ActionFuture<World> loadWorld() {
        ...
        return future.thenCompose(new Function<World, ActionFuture<World>>() {
            ...
            public ActionFuture<World> apply(World world) {
                return ArenaNew.this.plugin.getGeneratorHandler().getWorldAdaptor().loadWorldFromSave(ArenaNew.this.settings.getName());
            }
        });
    }
    ...
    public ActionFuture<World> load() {
        ...
        return this.loadWorld().thenApply(new Function<World, World>() {
            ...
            public World apply(World world) {
                ...
                ArenaNew.this.world = world;
                ArenaNew.this.arenaHandler.register();
                ArenaNew.this.setStatus(ArenaStatus.IDLING);
                return world;
            }
        });
    }
    ...
    public void joinGame(ArenaPlayer player) {
        ...
        Message message = Lang.ARENA_JOIN_MESSAGE.asMessage();
