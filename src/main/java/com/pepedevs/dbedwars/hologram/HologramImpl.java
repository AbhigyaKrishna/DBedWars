...
public class HologramImpl extends Hologram {
    ...
    protected HologramImpl(String id, Location location, HologramSettings settings) {
        super(id, location);
    ...
    @Override
    public HologramPageImpl addPage() {
        HologramPageImpl page = new HologramPageImpl(this, pages.size());
        pages.add(page);
        return page;
    }
    ...
    @Override
    public void changeSettings(HologramSettings settings) {
        this.settings = settings;
    }
