package com.pepedevs.dbedwars.game.arena.settings;
...
public class ArenaSettings implements com.pepedevs.dbedwars.api.game.settings.ArenaSettings {
    ...
    public void enableTeam(Color teamColor) {
        this.availableTeams.add(new com.pepedevs.dbedwars.game.arena.Team(plugin, teamColor));
    }
